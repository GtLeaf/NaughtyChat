package com.cmd.hit.main.Setting;
...
public class SettingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.main_setting_main);
        ...
        SettingAdapter adapt1 = new SettingAdapter(SettingActivity.this,R.layout.main_setting_list,routine);
        //ArrayAdapter<String> adapt1 = new ArrayAdapter<String>(this,android.R.layout.simple_list_item_checked,str1);
        BasicAdapter adapt2 = new BasicAdapter(SettingActivity.this,R.layout.main_settting_list2,str2);
        BasicAdapter adapt3 = new BasicAdapter(SettingActivity.this,R.layout.main_settting_list2,str3);
